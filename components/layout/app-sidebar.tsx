...
export function AppSidebar() {
  ...
  return (
    <aside className="flex h-full w-[260px] shrink-0 flex-col border-r border-neutral-200 bg-neutral-50">
      ...
      <div className="border-t border-neutral-200 px-5 py-4">
        ...
        <Link
          to="/"
          className="mt-1 inline-block text-xs text-neutral-400 underline-offset-4 hover:text-neutral-700 hover:underline"
        >
          Sign out
        </Link>
      </div>

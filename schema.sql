...
create index if not exists idx_complaints_society on complaints_and_suggestions(society_id, created_at desc);
create index if not exists idx_complaints_user on complaints_and_suggestions(raised_by_user_id);
create index if not exists idx_society_ledger_society on society_ledger(society_id, created_at desc);
...
create policy "complaints_read_all" on complaints_and_suggestions for select to authenticated, anon using (true);

drop policy if exists "complaints_write_all" on complaints_and_suggestions;
create policy "complaints_write_all" on complaints_and_suggestions for all to authenticated, anon using (true) with check (true);

drop policy if exists "complaints_write_service" on complaints_and_suggestions;
create policy "complaints_write_service" on complaints_and_suggestions for all to service_role using (true) with check (true);

drop policy if exists "society_ledger_read_all" on society_ledger;
create policy "society_ledger_read_all" on society_ledger for select to authenticated, anon using (true);

drop policy if exists "society_ledger_write_all" on society_ledger;
create policy "society_ledger_write_all" on society_ledger for all to authenticated, anon using (true) with check (true);

drop policy if exists "society_ledger_write_service" on society_ledger;
create policy "society_ledger_write_service" on society_ledger for all to service_role using (true) with check (true);

drop policy if exists "platform_settings_service" on platform_settings;
create policy "platform_settings_service" on platform_settings for all to service_role using (true) with check (true);

        ...
        <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-5">
          {isSuperAdmin && (
            <>
              ...
              <NavLink to="/super-admin/societies" className={navLinkClass}>
                Societies Manager
              </NavLink>
              <NavLink to="/super-admin/pricing" className={navLinkClass}>
                Pricing Engine
              </NavLink>
              <NavLink to="/super-admin/subscriptions" className={navLinkClass}>
          ...
          {showRwaNav && (
            <>
              ...
              <NavLink to="/rwa/notices" className={navLinkClass}>
                Notice Board
              </NavLink>
              ...
              <NavLink to="/rwa/activity" className={navLinkClass}>
                Activity Log
              </NavLink>

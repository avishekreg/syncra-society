...
export default function RwaDashboard() {
  ...
  return (
    <div className={ui.sectionGap}>
        ...
        {/* ── Operations: contracts / roles / notices — equal height ── */}
        <section className={`${ui.grid3} items-stretch`}>
          <article className={ui.cardFill}>
            <header className={ui.cardHeader}>
          ...
          <article className={ui.cardFill}>
            <header className={ui.cardHeader}>
              <p className={ui.eyebrow}>Notices</p>
              <h2 className={`mt-1 ${ui.heading}`}>Community announcements</h2>
            </header>
            <div className={ui.cardBody}>
        ...
        <section className={ui.grid2}>
          ...
          <article className={ui.cardFill}>
            ...
            <p className={ui.body}>
              Use the sidebar links to manage contracts, roles, notices, and ledgers with premium clarity.
            </p>
          </article>
        </section>
      </div>

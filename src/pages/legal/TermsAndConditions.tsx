    ...
    <LegalPageLayout title="Terms & Conditions">
      <LegalSection title="1. Agreement to Terms">
        <LegalParagraph>
          ...
          <strong>{LEGAL_ENTITY}</strong> (&quot;mAI Society&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) and
          ...
          software-as-a-service product operated by mAI Society.
        </LegalParagraph>
        <LegalParagraph>
      ...
      <LegalSection title="3. Description of Service">
        ...
        <LegalParagraph>
          mAI Society provides software tools and infrastructure only. We do not manage the internal affairs of any Society,
      ...
      <LegalSection title="4. Eligibility and Account Registration">
        ...
        <LegalParagraph>
          ...
          credentials and for all activity occurring under your account. You must notify mAI Society immediately at{' '}
      ...
      <LegalSection id="acceptable-use" title="5. Acceptable Use Policy">
        ...
        <LegalList
          items={[
            ...
            'Impersonate another resident, office-bearer, guard, vendor, or mAI Society personnel.',
            ...
            'Use the Platform in any manner that could expose mAI Society to regulatory penalty, civil liability, or reputational harm.'
          ]}
        />
        <LegalParagraph>
          Societies are solely responsible for moderating User Content submitted by their residents and for taking
          appropriate action under their internal governance processes. mAI Society may, but is not obligated to, review User
      ...
      <LegalSection id="subscription" title="7. Subscription Terms, Billing, and Payment">
        <LegalParagraph>
          ...
          module charges as displayed on the Platform or in a written order form or invoice issued by mAI Society. All fees are
        ...
        <LegalParagraph>
          mAI Society may revise pricing for renewal periods upon reasonable prior notice. Continued use after the effective
      ...
      <LegalSection id="termination" title="8. Account Suspension and Termination">
        <LegalParagraph>
          mAI Society may suspend or terminate a Society&apos;s access to the Platform, in whole or in part, immediately and
          without refund if:
        </LegalParagraph>
        <LegalList
          items={[
            ...
            'mAI Society reasonably believes the account is compromised or used for fraud or abuse.'
          ]}
        />
        <LegalParagraph>
          Upon suspension for non-payment, resident-facing features, automated messaging, and administrative dashboards
          may be disabled until outstanding amounts are settled. Upon termination, mAI Society may delete or anonymize Society
      ...
      <LegalSection title="9. Intellectual Property">
        <LegalParagraph>
          mAI Society and its licensors retain all right, title, and interest in the Platform, including software, designs,
        ...
        <LegalParagraph>
          You retain ownership of User Content you submit. You grant mAI Society a non-exclusive, worldwide, royalty-free
      ...
      <LegalSection id="liability" title="10. Disclaimers and Limitation of Liability">
        ...
        <LegalParagraph>
          mAI Society is a software provider only. We are not a party to disputes between residents, between residents and
        ...
        <LegalParagraph>
          To the fullest extent permitted by law, mAI Society shall not be liable for any indirect, incidental, special,
        ...
        <LegalParagraph>
          mAI Society&apos;s aggregate liability for all claims arising out of or relating to these Terms or the Service shall
          not exceed the total subscription fees actually paid by the Society to mAI Society in the twelve (12) months
      ...
      <LegalSection title="11. Indemnification">
        <LegalParagraph>
          You agree to indemnify, defend, and hold harmless mAI Society, its directors, officers, employees, and contractors
      ...
      <LegalSection title="12. Third-Party Services">
        <LegalParagraph>
          ...
          third-party terms. mAI Society is not responsible for outages, policy changes, or acts of third-party providers
      ...
      <LegalSection title="15. Force Majeure">
        <LegalParagraph>
          mAI Society shall not be liable for any delay or failure to perform obligations under these Terms (other than
          payment obligations already accrued) where such delay or failure results from events beyond mAI Society&apos;s
      ...
      <LegalSection title="16. Assignment and Subcontracting">
        <LegalParagraph>
          You may not assign or transfer your rights or obligations under these Terms without mAI Society&apos;s prior
          written consent. mAI Society may assign these Terms in connection with a merger, acquisition, corporate
          reorganization, or sale of substantially all assets, or to an affiliate, provided the assignee agrees to
          honour these Terms. mAI Society may use subcontractors and subprocessors to deliver the Service, subject to
      ...
      <LegalSection title="18. Changes to Terms">
        <LegalParagraph>
          mAI Society may update these Terms from time to time. Material changes will be notified through the Platform, by
